...
const StudentConnectionsSidebar = () => {
  ...
  const handleConnect = async (friend_id) => {
    ...
    try {
      const response = await connectToFriend({ id: currentUserId, friend_id, friend_type: "user" }).unwrap();
...
export default StudentConnectionsSidebar;
